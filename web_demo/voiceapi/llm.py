...
* **當使用者詢問「AIGC影片」時，回答：**
    "運用 AI技術，6–10 天即可完成高品質影音內容，僅需傳統製作 40–60% 的預算、2–3 人即可執行。無論是廣告、社群短影音、教學內容或品牌形象影片，皆可靈活應用，幫助品牌快速掌握影音行-銷主導權，放大影響力。"
...
def get_standard_response(prompt):
    ...
    if "aigc" in prompt_lower or "影片" in prompt_lower:
        return "運用 AI技術，6–10 天即可完成高品質影音內容，僅需傳統製作 40–60% 的預算、2–3 人即可執行。無論是廣告、社群短影音、教學內容或品牌形象影片，皆可靈活應用，幫助品牌快速掌握影音行-銷主導權，放大影響力。"
